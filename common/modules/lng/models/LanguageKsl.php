...
namespace common\modules\lng\models;
...
class LanguageKsl {
    ...
    {
        if(!$languages = Yii::$app->getModule('lng')->languages)
            $languages = SiteLang::getAllArray();
    ...
    public static function parsingUrl($language, $url_referrer) {
        ...
        $default_language = Yii::$app->getModule('lng')->default_language;
        $show_default = Yii::$app->getModule('lng')->show_default;
