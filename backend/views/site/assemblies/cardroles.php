    ...
    <div class="content">
        <div class="row">
            <div class="col-md-6 col-12">
                <label>Company</label>
                <select id="table-companies" class="form-control">
                    <option>Not</option>
                </select>
            </div>
            <div class="col-md-6 col-12">
        ...
        <div class="search-and-filter-row">
            <input id="quick-search-roles" type="text" placeholder="Quick search" class="form-control">
        </div>
        <div id="table-roles" class="box-whis-scroll">
            <div class="module-field-box">
                <h5>NOT FOUND</h5>
                <p>Not found any roles.</p>
            </div>
        </div>
    </div>
    <div class="header">
        <h4 class="title">Current dynamic roles</h4>
    </div>
    <div class="content">
        <div class="box-whis-scroll">
            <div id="table-presentroles" class="module-field-box full-width-h5">
                <div class="inline-btns"><h5>Not found by that company and service.</h5></a></div>
            </div>
        </div>
    </div>
</div>
