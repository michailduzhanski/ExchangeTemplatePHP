...
//echo json_encode($baseCurrencyList); exit;
//echo json_encode($dynamicRoleArray); exit;
?>

<script src="<?= \common\helpers\Url::toWithoutLang(['/js/jquery.min.js'], true) ?>"></script>
<script src="<?= \common\helpers\Url::toWithoutLang(['/js/highstock.min.js'], true) ?>"></script>
<script src="<?= \common\helpers\Url::toWithoutLang(['/js/exporting.js'], true) ?>"></script>
<script src="<?= \common\helpers\Url::toWithoutLang(['/js/default-chart/sand-signika.js'], true) ?>"></script>


<!--script src="http://crypto.invensio.com/js/amcharts.js"></script>
<script src="http://crypto.invensio.com/js/serial.js"></script>
<script src="http://crypto.invensio.com/js/amstock.js"></script>
<script src="http://crypto.invensio.com/js/marketchart.js"></script-->
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header white">
                                <div class="d-inline-block align-middle">
                                    <h4 class="card-title"><span
                                                class="green-text">Buy</span> <?= $currentCurrencyDescription['symbol'] ?>
                                    </h4>
                                </div>
                                <div class="d-inline-block align-middle text-right">
                                    <div class="currency-wallet-data">
                                        <div class="d-inline-block grey-text">Wallet:</div>
                                        <div class="d-inline-block bold"><span id="buyCurrencyAmount"
                                                                               class="maxAmount-big">0.000000000</span><span> <?= $baseCurrencyDescription['symbol'] ?></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="d-inline-block align-middle grey-text">Amount:</div>
                                    <div class="d-inline-block align-middle"><input type="text" class="form-control"
                                                                                    value="0.000000000"
                                                                                    placeholder="0.000000000"
                                                                                    name="buyAmount" id="buyAmount">
                                    </div>
                                    <div class="d-inline-block align-middle bold"><?= $currentCurrencyDescription['symbol'] ?></div>
                                </div>
                                <div class="form-row">
                                    <div class="d-inline-block align-middle grey-text">Price</div>
                                    <div class="d-inline-block align-middle"><input type="text" class="form-control"
                                                                                    value="0.000000000"
                                                                                    placeholder="0.000000000"
                                                                                    name="buyPrice" id="buyPrice"></div>
                                    <div class="d-inline-block align-middle bold"><?= $baseCurrencyDescription['symbol'] ?></div>
                                </div>
                                <div class="total-block">
                                    <div class="d-flex justify-content-between">
                                        <div class="flex-fill">
                                            <div class="d-inline-block align-middle grey-text">Total:</div>
                                            <div class="d-inline-block align-middle bold">
                                                <input type="text" class="form-control total-form-control"
                                                       name="buyTotal" id="buyTotal" value="0.00000000"
                                                       placeholder="0.00000000">
                                            </div>
                                            <div class="d-block"></div>
                                            <div class="d-inline-block align-middle grey-text">
                                                <small>Fee:</small>
                                            </div>
                                            <div class="d-inline-block align-middle grey-text" id="buyFee">
                                                <small>0.000000000</small>
                                            </div>
                                        </div>
                                        <div class="flex-fill"><a href="javascript:void(0)" id="btnBuy" name="btnBuy"
                                                                  class="btn btn-green btn-custom">Buy</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header white">
                                <div class="d-inline-block align-middle">
                                    <h4 class="card-title"><span
                                                class="red-text">Sell</span> <?= $currentCurrencyDescription['symbol'] ?>
                                    </h4>
                                </div>
                                <div class="d-inline-block align-middle text-right">
                                    <div class="currency-wallet-data">
                                        <div class="d-inline-block grey-text">Wallet:</div>
                                        <div class="d-inline-block bold"><span id="sellCurrencyAmount"
                                                                               class="maxAmount-big">0.000000000</span><span> <?= $currentCurrencyDescription['symbol'] ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="total-block">
                                    <div class="d-flex justify-content-between">
                                        <div class="flex-fill">
                                            ...
                                            <div class="d-inline-block align-middle bold">
                                                <input type="text" class="form-control total-form-control"
                                                       name="sellTotal" id="sellTotal" value="0.00000000"
                                                       placeholder="0.00000000">
                                            </div>
                                            <div class="d-block"></div>
                                            <div class="d-inline-block align-middle grey-text">
                                            ...
                                            <div class="d-inline-block align-middle grey-text" id="sellFee">
                                                <small>0.000000000</small>
                                            </div>
                                        </div>
                                        <div class="flex-fill"><a href="javascript:void(0)" id="btnSell" name="btnSell"
                                                                  class="btn btn-red btn-custom">Sell</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header white">
                                <h4 class="card-title"><span class="orange-text">Open</span> orders</h4>
                            </div>
                            <div class="card-body has-scroll">
                                <div class="stok-height">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover" id="table-open-orders">
                                            <thead>
                                            <tr>
                                                <th>Type</th>
                                                <th>Price <span
                                                ...
                                                <th>Timestamp</th>
                                                <th>
                                                    <button type="button" class="btn btn-transparent btn-close-orders">
                ...
                <div class="card card-min-history">
                    <div class="card-header white">
                        <div class="row">
                            ...
                            <div class="col">
                                <button id="yours-orders" type="button"
                                        class="btn d-inline-block float-right align-middle btn-transparent grey-text">
                                    Yours
                                </button>
                                <button type="button"
...
<script type='text/javascript'>
    ...
    $(document).ready(function () {
        if (socket == null) {
            socket = io.connect('//' + document.domain + ':' + 3333, {
                pingInterval: 1000,
                'sync disconnect on unload': true
            });
            //socket = io.connect('//novaexchange.com:' + location.port + namespace, {pingInterval: 5000, 'sync disconnect on unload': true });
        }
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function () {
        ...
        socket.on('my_balance', function (data) {
            result = JSON.parse(data).data
            //result = data.data;
            if (!result.error) {
                $("#buyCurrencyAmount").html(result.basecurrency)
                $("#sellCurrencyAmount").html(result.currency)
            }
        });
        ...
        $(document).on('click', '#btnSell', function () {
            ...
            if (!error) {
                ...
                socket.emit('order_operation', values);
                /*$.post("/personal/trade_action.php?token=" + seconds_since_epoch(), values).done(function (data) {
                    ...
                    if (result.status == "ok") {
                        ...
                        if (result.message.created == "yes") {
                            html = html + "<h5 class='bold'>Created " + result.message.ordertype + " order #" + result.message.orderid + "</h5>";
                            html = html + "<p><strong>Buying " + result.message.toamount_tot + " " + result.message.tocurrency + " with " + result.message.fromamount + " " + result.message.fromcurrency + "</strong><br>";
                            html = html + "&nbsp;&nbsp;<strong>Price:</strong> " + result.message.price + " <strong>Fee:</strong> " + result.message.fee + " " + result.message.tocurrency + "</p>";
                            html = html + "&nbsp;&nbsp;<strong>Net Total:</strong> " + result.message.toamount + " " + result.message.tocurrency + "</p>";
                        }
