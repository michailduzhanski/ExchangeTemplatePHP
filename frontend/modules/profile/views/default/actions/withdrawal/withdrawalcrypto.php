...
$currentPageFilters = '[{"map":"' . getIndexFromArray(json_decode($currentStructure, true), 'af8e49fc-2a70-4143-9f59-69232bddfc69') . '","comp":"6","value":"1"}]'
?>
...
<div class="content-wrapper">
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div>
                        ...
                        <div class="row">
                            <div class="col">
                                <a href="" class="btn btn-default btn-block btn-lg with-mr-t">
                                <?=Yii::t('frontend', 'Cancel')?>
                            	</a>
                            </div>
                            <div class="col">
                                <a id="donehref" href="" class="btn btn-success btn-block btn-lg with-mr-t">
                                <?=Yii::t('frontend', 'Done')?>
                            	</a>
                            </div>
                        </div>
        ...
        <div class="col-xl-8 col-lg-8 col-md-6 col-sm-12 col-12">
            <div class="card">
                <div class="card-header white">
                    <h3 class="card-title"><?=Yii::t('withdraw_page', 'Withdrawal history')?></h3>
                </div>
...
<script>
    ...
    $('#ht-auto-search').on("change", function (event) {
        ...
        $('#donehref').attr("href", ("/en/profile/default/wdone?currency=" + $(document.getElementById('ht-auto-search')).val()));
    })
