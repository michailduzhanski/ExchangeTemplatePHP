    ...
    <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
            <div class="card">
                <div class="card-header white">
                    <h3 class="card-title"><?=Yii::t('withdraw_page', 'Withdraw')?></h3>
                </div>
                <div class="card-body">
                    <?php $form = ActiveForm::begin([
                        'id' => 'wdone-form',
                        'action' => Url::to('/profile/default/wdone'),
                        'validateOnChange' => false,
                        'validateOnBlur' => false,
                        'validateOnSubmit' => true,
                        'enableAjaxValidation' => true,
                        'validationUrl' => Url::to('/profile/default/wdone-validate')
                    ]) ?>
                        ...
                        <label class="d-none grey-text">
                            <?=Yii::t('withdraw_page', 'Currency')?>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-12">
                                ...
                                <?=$form->field($model, 'total')->hiddenInput([
                                    'id' => 'wdone-total'
                                ])->label(false) ?>
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="total-block">
                                    <span class="grey-text">
                                        <?=Yii::t('withdraw_page', 'Fee')?>: <span id="partfee">0.00000000</span></span>
                                    <p class="bold"><?=Yii::t('withdraw_page', 'Total')?>: <span id="partvalue"
                        ...
                        <div class="withdraw-to">
                            <?=$form->field($model, 'address', [
                                ...
                                'class' => 'form-control',
                                'placeholder' => Yii::t('withdraw_page', 'Currency wallet number'),
                        ...
                        <div class="transfer-verification row">
                            ...
                            <div class="col">
                                ...
                                <?= \common\modules\pinCode\widgets\SendCode::widget(
                                    ['message' => Yii::t('frontend', 'Pin code for withdraw')]
                                ) ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <?php $wcrypto = \yii\helpers\Url::to(['/profile/default/wcrypto'])?>
                                <button onclick="location.href='<?=$wcrypto?>'" class="btn btn-default btn-block btn-lg with-mr-t"><?=Yii::t('frontend','Cancel')?></button>
                            </div>
                            <div class="col">
                                <button id="wdone-submit" type="submit" class="btn btn-success btn-block btn-lg with-mr-t"><?=Yii::t('frontend','Done')?></button>
                            </div>
                        </div>
        ...
        <div class="col-xl-8 col-lg-8 col-md-6 col-sm-12 col-12">
            <div class="card">
                <div class="card-header white">
                    <h3 class="card-title">                    
                    <?=Yii::t('withdraw_page', 'Withdrawal history') ?>
                    </h3>
                </div>
