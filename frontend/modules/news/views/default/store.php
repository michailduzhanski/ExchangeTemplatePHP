...
foreach ($newsResult as $nextNews) {
    $url = Url::to(['/news/default/topic', 'id' => $nextNews['id']]);
    $img =  ImageStorageHelper::getImgUrl('655d85fa-2199-40fe-9836-295bf8a8a316', $nextNews['titleimage'], 'news', 'preview');
    if($img)
        $img = '<img src="' . $img . '" alt="" class="img-responsive">';
    else $img = '';
    $allNews .= '<a class="news-item-short" href="' . $url . '">
                    '.$img.'
        ...
        <div class="row">
            ...
            <div class="col-sm-8 col-xs-12">
                <div class="news-page-item">
                    <?php
                    $img =  ImageStorageHelper::getImgUrl('655d85fa-2199-40fe-9836-295bf8a8a316', $currentNewsArray['titleimage'], 'news', 'large');
                    if($img)
                        $img = '<img src="'.$img.'" class="img-responsive" alt="">';
                    else
                        $img = '';
                    ?>
                    <?=$img ?>
            ...
            <div class="col-sm-3 col-xs-12">
                <h3 class="section-title text-right with-border-bottom">
                    <?=Yii::t('news_page', 'Other news')?>
                </h3>
                <?= $allNews ?>
            </div>
        </div>
